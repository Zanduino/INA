...
enum ina_237_Mode
{
  INA_237_MODE_SHUTDOWN,              ///< Device powered down
  INA_237_MODE_TRIGGERED_BUS,         ///< Triggered bus
  INA_237_MODE_TRIGGERED_SHUNT,       ///< Triggered shunt
  INA_237_MODE_TRIGGERED_BUS_SHUNT,   ///< Triggered bus and shunt
  INA_237_MODE_TRIGGERED_TEMP,        ///< Triggered temp
  INA_237_MODE_TRIGGERED_TEMP_BUS,    ///< Triggered temp and bus
  INA_237_MODE_TRIGGERED_TEMP_SHUNT,  ///< Triggered temp and shunt
  INA_237_MODE_TRIGGERED_ALL,         ///< Triggered temp, shunt and bus
  INA_237_MODE_POWER_DOWN,            ///< Device powered down
  INA_237_MODE_CONTINUOUS_BUS,        ///< Continuous bus
  INA_237_MODE_CONTINUOUS_SHUNT,      ///< Continuous shunt
  INA_237_MODE_CONTINUOUS_BUS_SHUNT,  ///< Continuous bus and shunt
  INA_237_MODE_CONTINUOUS_TEMP,       ///< Continuous temp
  INA_237_MODE_CONTINUOUS_BUS_TEMP,   ///< Continuous bus and temp
  INA_237_MODE_CONTINUOUS_TEMP_SHUNT, ///< Continuous temp and shunt
  INA_237_MODE_CONTINUOUS_ALL,        ///< Continuous temp, shunt and bus
};                                    // of enumerated type
/************************************************************************************************
...
const uint16_t INA_MANUFACTURER_ID(0x5449);            ////< Mfgr ID (some devices)  'TI' in ASCII, cute huh?
...
const uint8_t INA237_BUS_VOLTAGE_REGISTER{5};          ///< INA237 Bus Voltage Register
const uint8_t INA237_SHUNT_VOLTAGE_REGISTER{4};        ///< INA237 Shunt Voltage Register
const uint8_t INA237_CURRENT_REGISTER{7};              ///< INA237 Current Register
const uint16_t INA237_BUS_VOLTAGE_LSB{313};            ///< INA237 LSB in uV *100 3.125mV
const uint16_t INA237_SHUNT_VOLTAGE_ADCRANGE0_LSB{50}; ///< INA237 LSB in uV *10  5.0uV
const uint16_t INA237_SHUNT_VOLTAGE_ADCRANGE1_LSB{13}; ///< INA237 LSB in uV *10  1.25uV
const uint16_t INA237_CALIBRATION_REGISTER{0x2};  ///< INA237 shunt cal register
const uint8_t INA237_MANUFACTURER_ID_REGISTER{0x3E};   ///< INA237 Mfgr ID Register
const uint16_t INA237_DEFAULT_OPERATING_MODE{0b111100000000000};        ///< Default continuous mode
